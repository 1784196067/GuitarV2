 ...
 * Generated at: 2017-05-14 15:04:24 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t\t<div><label>builder：</label><input type=\"text\" name=\"builder\"/></div>\r\n");
      out.write("\t\t\t\t\t<div><label>model：</label><input type=\"text\" name=\"model\"/></div>\r\n");
      out.write("\t\t\t\t\t<div><label>type：</label><input type=\"text\" name=\"type\"/></div>\r\n");
      out.write("\t\t\t\t\t<div><label>backWood：</label><input type=\"text\" name=\"backWood\"/></div>\r\n");
      out.write("\t\t\t\t\t<div><label>topWood：</label><input type=\"text\" name=\"topWood\"/></div>\t\r\n");
      out.write("\t\t\t\t  </div>\r\n");
      out.write("\t\t\t\t\t<span class=\"btn btn-info\" style=\"float:right;\" onclick=\"search()\"><span class=\"glyphicon glyphicon-search\"></span>搜索</span>\r\n");
      out.write("\t\t\t\t</form>\r\n");
      out.write("\t\t\t</section>\r\n");
      out.write("\t   </section>\r\n");
      ...
      out.write("\t  $.post(\"guitar/search_search\", $(\"#form1\").serialize(),\r\n");
